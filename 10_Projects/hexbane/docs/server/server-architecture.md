...
- Race picked at random from the registry at `MatchInit` (`bot.go:53-59`, `init.go:60`); base stats are the per-race level-1 spreads from migration `000002_reference_data` (`bot.go:34-41`); 200 HP / 100 mana.
