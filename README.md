...
2. Say **"run my identity onboarding"** to populate `00_Identity/`.
3. Start capturing — the agent routes notes per `AGENTS.md`.

> The `example-project` and `open-banking-sca` notes are demos — delete them once you have real content.
